...
#tensorboard setting
train_writer = tf.summary.create_file_writer('thesis/SRGAN/logs/train/'+time.strftime("%Y_%m_%d-%H_%M_%S"))
#test_writer = tf.summary.create_file_writer('thesis/SRGAN/logs/test/'+time.strftime("%Y_%m_%d-%H_%M_%S"))
losses_g = []
losses_d = []
psnr_values=[]
ssim_values=[]
